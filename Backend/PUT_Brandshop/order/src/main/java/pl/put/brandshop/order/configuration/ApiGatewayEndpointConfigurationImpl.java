package pl.put.brandshop.order.configuration;
...
public class ApiGatewayEndpointConfigurationImpl implements ApiGatewayEndpointConfiguration
{
    ...
    public void initMap()
    {
        ...
        endpointList.add(new Endpoint("api/v1/order/order-list", HttpMethod.GET, Role.ADMIN));
        endpointList.add(new Endpoint("api/v1/order/status-set", HttpMethod.PATCH, Role.ADMIN));
        endpointList.add(new Endpoint("api/v1/deliver", HttpMethod.GET, Role.GUEST));
        endpointList.add(new Endpoint("api/v1/order/payment", HttpMethod.GET, Role.GUEST));
    }
