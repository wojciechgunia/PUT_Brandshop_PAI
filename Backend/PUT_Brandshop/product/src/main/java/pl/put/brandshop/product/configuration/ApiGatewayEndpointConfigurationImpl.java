package pl.put.brandshop.product.configuration;
...
public class ApiGatewayEndpointConfigurationImpl implements ApiGatewayEndpointConfiguration
{
    ...
    public void initMap()
    {
        ...
        endpointList.add(new Endpoint("api/v1/product/admin-get", HttpMethod.GET, Role.ADMIN));
        ...
        endpointList.add(new Endpoint("api/v1/product", HttpMethod.PATCH, Role.ADMIN));
        ...
        endpointList.add(new Endpoint("api/v1/category", HttpMethod.DELETE, Role.ADMIN));
        endpointList.add(new Endpoint("api/v1/category/get-admin", HttpMethod.GET, Role.ADMIN));
    }
